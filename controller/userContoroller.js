...
module.exports = {
    ...
    updateDiterima: async (req,res) => {
        try {
            const {id} = req.params
            const data = await userModel.updateFriend(id)
            res.send({
    ...
    getCountrequest: async (req,res) => {
        try {
            const {id} = req.params
            const data = await userModel.countfriend(id)
            res.send({
    ...
    getCountrequestactive: async (req,res) => {
        try {
            const {id} = req.params
            const data = await userModel.countfriendactive(id)
            res.send({
                message: "count berhasil",
                data: data
            })
